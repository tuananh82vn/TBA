...
// The Main Class
open class SCLAlertView: UIViewController, UITextFieldDelegate {
    ...
    var durationTimer: Foundation.Timer!
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?, colorTextButton: UInt?) -> SCLAlertViewResponder {
        ...
        if duration > 0 {
            ...
            durationTimer = Foundation.Timer.scheduledTimer(timeInterval: duration!, target: self, selector: #selector(SCLAlertView.hideView), userInfo: nil, repeats: false)
        }
