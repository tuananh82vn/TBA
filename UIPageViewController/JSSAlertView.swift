...
class JSSAlertView: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        if self.textView != nil {
            ...
            //let textRect   = textString.boundingRectWithSize(<#T##size: CGSize##CGSize#>, options: <#T##NSStringDrawingOptions#>, attributes: <#T##[String : AnyObject]?#>, context: <#T##NSStringDrawingContext?#>)
